/**
 * Peblar (Home, Business, Pro) Vendor Error & Warning Codes
 * Structured into:
 * - 4-digit Error Codes (halting charging, mapped to OCPP errorCodes)
 * - 5-digit Warning Codes (non-critical, operating with reduced functionality)
 */
...
export const PEBLAR_CODES: Record<string, PeblarCodeInfo> = {
  ...
  "10300": {
    ...
    resolution: "Check firewall UDP port 123 access for legal metrology Eichrecht clock synchronization.",
    severity: "LOW",
    category: "Communications",
    ocppErrorCodeMapped: "NoError",
  },
