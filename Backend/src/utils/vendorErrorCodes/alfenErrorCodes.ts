/**
 * Alfen Eve Series (Eve Single Pro, Eve Double Pro, Twin) Vendor Error Codes
 * Grouped into: Internal (100s), Installation (200s), EV Side (300s), External (400s)
 */
...
export function getAlfenErrorInfo(code?: string | null): AlfenErrorCodeInfo | undefined {
  ...
  if (ALFEN_ERROR_CODES[clean]) {
    return ALFEN_ERROR_CODES[clean];
  }

  // Search inside string (e.g. "Alfen Eve: 101" or "Error 401")
