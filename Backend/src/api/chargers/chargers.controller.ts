    ...
    const [chargers, total] = await Promise.all([
      prisma.charger.findMany({
        ...
        include: {
          ...
          ownerCompany: true,
          subscriptionPayerUser: { select: { id: true, email: true, name: true } },
          subscriptionPayerCompany: true,
          transactionReceiverUser: { select: { id: true, email: true, name: true } },
          transactionReceiverCompany: true,
          product: true,
        },
  ...
  try {
    ...
    const charger = await prisma.charger.findUnique({
      ...
      include: {
        ...
        owner: { select: { id: true, email: true, name: true, companyId: true } },
        ownerCompany: true,
        subscriptionPayerUser: { select: { id: true, email: true, name: true } },
        subscriptionPayerCompany: true,
        transactionReceiverUser: { select: { id: true, email: true, name: true } },
  ...
  try {
    ...
    const charger = await prisma.charger.create({
      data: {
        ...
        owner_id,
        ownerType: chargerData.ownerType || "user",
        ownerCompanyId: chargerData.ownerCompanyId ? Number(chargerData.ownerCompanyId) : null,
        subscriptionPayerType: chargerData.subscriptionPayerType || null,
        subscriptionPayerUserId: chargerData.subscriptionPayerUserId ? Number(chargerData.subscriptionPayerUserId) : null,
        subscriptionPayerCompanyId: chargerData.subscriptionPayerCompanyId ? Number(chargerData.subscriptionPayerCompanyId) : null,
        transactionReceiverType: chargerData.transactionReceiverType || null,
        transactionReceiverUserId: chargerData.transactionReceiverUserId ? Number(chargerData.transactionReceiverUserId) : null,
        transactionReceiverCompanyId: chargerData.transactionReceiverCompanyId ? Number(chargerData.transactionReceiverCompanyId) : null,
      ...
      include: {
        ...
        owner: true,
        ownerCompany: true,
        subscriptionPayerUser: true,
        subscriptionPayerCompany: true,
        transactionReceiverUser: true,
        transactionReceiverCompany: true,
        tariffs: true,
        pairedCharger: true,
        product: true
...
export const updateCharger = async (req: Request, res: Response) => {
  try {
    ...
    const allowedFields = [
      ...
      "subscriptionPayerUserId",
      "subscriptionPayerCompanyId",
      "transactionReceiverType",
      "transactionReceiverUserId",
      "transactionReceiverCompanyId",
      "tariffId",
      "isPublic",
