/**
 * Raedian EV Charger Vendor Error Codes & Remediation Definitions (Frontend)
 * Models supported: Raedian NEX & Raedian Gemini
 *
 * Supports both E-code format ("E00008") and 16-bit hex format ("0x0008", "0x2010", etc.)
 * as transmitted by Raedian hardware over OCPP 1.6-J.
 */
...
export const RAEDIAN_ERROR_CODES: Record<string, RaedianErrorCodeInfo> = {
  E00002: {
    ...
    solution: "Reinsert the charging cable in the car and restart charging. If the fault reoccurs, contact customer support of EV.",
    severity: "CRITICAL",
  ...
  E00020: {
    ...
    solution: "Restart charging after a while. If the fault reoccurs, contact customer support of EV.",
    severity: "HIGH",
    category: "PowerElectronics",
