...
The **Charge Grid Ground Plan** module is an enterprise feature that enables Station Managers, Facility Engineers, and CPOs to create interactive 2D parking ground plans, map electrical topologies, and monitor real-time EV charging statuses across physical bays.
...
4. Once enabled, the **Edit Ground Plan Layout** and **Live View** buttons appear on the station detail page.
...
* **Draw Area:** Creates a customizable rectangular zone to represent buildings, customer lounges, solar canopies, or transformer substations.
* **Draw Line:** Places customizable lines to represent lane markings, curbs, perimeter fences, or electrical supply cabling from distribution panels.
...
* **Labeling:** Type inside the spot or area header to assign custom bay names (e.g., *"VIP Bay 1"*, *"DC Fast Bay 01"*).
* **Assign Connector Socket:** Use the dropdown inside each parking bay to link an available physical charger socket (e.g., `Alfen-01 / Connector 1`) to that parking space.
* **Electrical Topology & Phase Mapping:** Assign feeder lines to map electrical circuits (L1, L2, L3) directly to charge points for site phase balancing visualization.
...
* ⚡ **Charging (Pulsing Green glow):** A vehicle is connected and actively drawing power. The bay tile displays:
  ...
  * Phase Current Balance (**L1 / L2 / L3 Amps**)
